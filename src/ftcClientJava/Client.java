...
import cg.common.io.logging.OnLineWritten;
import cg.common.io.logging.DelegatingOutputStream;
...
public class Client {
	...
	private static Runnable startup() {
		...
		final ftcClientController controller = new ftcClientController(model, logging, connector, clientSettings,
				new PreferencesStringStorage(uglySmallThings.Const.PREF_ID_CMDHISTORY, Client.class));

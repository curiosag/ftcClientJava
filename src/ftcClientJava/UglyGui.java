...
public class UglyGui extends JFrame implements ActionListener, Observer {
	...
	public UglyGui(ActionListener controller, SyntaxElementSource syntaxElements, CompletionsSource completionsSource) {
	...
	private void buildGui() {
		...
		queryEditor = new QueryEditor(syntaxElements, completionsSource, null);
	...
	static UglyGui createAndShowGUI(ActionListener controller, SyntaxElementSource s, CompletionsSource c) {
		UIManager.put("swing.boldMetal", Boolean.FALSE);

		UglyGui result = new UglyGui(controller, s, c);
